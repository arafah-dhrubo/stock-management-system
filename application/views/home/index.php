...
<main class="w-11/12 mx-auto">
            ...
            <?php foreach ($data['products'] as $value) { ?>
                <div class="bg-white hover:shadow-md p-3 h-96 w-60">
                    <div class="md:h-48 lg:h-56">
                        <img src="<?php echo base_url() . 'images/' . $value->image ?>" class="rounded-md h-full w-full mx-auto"
    ...
    <div class="mt-28 flex gap-3">
        <div class="p-16 border">
            ...
            <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, asperiores autem beatae in inventore maiores!</p>
