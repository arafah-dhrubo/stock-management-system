    ...
    <main class="bg-purple-50 h-screen">
        <div class="flex items-center h-screen justify-center">
            <div class="bg-white shadow w-3/4 md:w-1/4 px-3 py-5 ">
                ...
                Already
                registered? <?php echo anchor("accounts/login", "Login", ['class' => 'mb-2 text-indigo-500 hover:text-indigo-600']); ?>
                here.
                ...
                <a href="<?php echo base_url() . 'accounts/google_login' ?>">
                    <img class="mt-2" src="<?php echo base_url() . 'assets/google_login.png' ?>"
