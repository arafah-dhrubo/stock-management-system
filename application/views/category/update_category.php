...
<div class="pr-3 col-span-10 mt-3 w-full">
	<div class="bg-white p-3 w-full shadow">
		<div class="flex justify-between mb-3">
			<h1 class="text-3xl font-semibold">Update Categories</h1>
		...
		<form action=" <?php echo base_url() . 'category/update_category/' . $query['id'];
		?>" method="post">
